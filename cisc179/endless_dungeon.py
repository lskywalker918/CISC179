...
class enemyStat: #Enemy stat block
...
a1= enemyStat('Kobold', 10, 12, 'A reptilian creature about the size of a five-year-old human child. It holds a sling in its hand, looking more ferocious than a child.', 'Sling', 4, 3, 6)
a2= enemyStat('Direwolf', 22, 14, 'This is no common dog or wolf. It is larger than any canine you have ever seen. Its fur is matted and it looks very hungry.', 'Bite', 5, 5, 15)
a3= enemyStat('Lion', 19, 12, 'The lion is definitely not sleeping tonight.', 'Claw', 5, 4, 9)
a4= enemyStat('Bugbear', 24, 16, 'This is neither a bear nor a bug. It is an angry hairy goblinoid. It is holding a mean-looking morningstar.', 'Morningstar', 4, 3, 18)
a5= enemyStat('Flying Sword', 14, 17, "While the sword remains motionless, it is indistinguishable from normal sowrd. Don't go touching random things.", 'Longsword', 3, 1, 8)
a6= enemyStat('Fire Snake', 30, 14, 'Lucky for you, the fire snake does not spit fire.', 'Bite', 3, 2, 5)
a7= enemyStat('Intellect Devourer', 28, 13, 'A large, glistening brain with four short, clawed legs. Relieved that you escaped its notice, you are slightly offended that it does not detect your intelligence.', 'Claw', 5, 4, 9)
a8= enemyStat('Red Dragon', 30, 19, 'This red dragon is the largest you have ever seen. It seems to have difficulty flying and can only roll along the floor.', 'Roll over', 8, 10, 20)
a9= enemyStat('Killer Rabbit of Caerbannog', 72, 20, 'Anyone got the Holy Hand Grenade of Antioch?', 'Nasty, big, pointy teeth', 9, 11, 36)
